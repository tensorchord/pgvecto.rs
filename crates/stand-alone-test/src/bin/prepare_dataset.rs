...
fn main() {
    ...
    MmapArray::create(Path::new("/home/yanqi/stand-alone-test/data/sift_vectors"), vecs_iter);
    MmapArray::create(Path::new("/home/yanqi/stand-alone-test/data/sift_payload"), (0..vecs.len()).map(|i| {
