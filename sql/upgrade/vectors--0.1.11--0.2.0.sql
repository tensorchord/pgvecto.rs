...
CREATE TYPE vecf16;
ALTER TYPE VectorIndexInfo RENAME TO vector_index_stat;
...
ALTER TYPE vector_index_stat DROP ATTRIBUTE indexing;
ALTER TYPE vector_index_stat DROP ATTRIBUTE idx_tuples;
ALTER TYPE vector_index_stat DROP ATTRIBUTE idx_sealed_len;
ALTER TYPE vector_index_stat DROP ATTRIBUTE idx_growing_len;
...
ALTER TYPE vector_index_stat DROP ATTRIBUTE idx_config;
