...
fn _vectors_vecf16_sphere_l2_in(
    ...
    Vecf16Borrowed::operator_l2(lhs.as_borrowed(), center.as_borrowed()) < F32(radius)
}
...
fn _vectors_vecf16_sphere_dot_in(
    ...
    Vecf16Borrowed::operator_dot(lhs.as_borrowed(), center.as_borrowed()) < F32(radius)
}
...
fn _vectors_vecf16_sphere_cos_in(
    ...
    Vecf16Borrowed::operator_cos(lhs.as_borrowed(), center.as_borrowed()) < F32(radius)
}
